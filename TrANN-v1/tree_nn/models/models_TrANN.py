...
class Ensemble:
    ...
    def predict(self, X):
        return [tree.predict(X).reshape(-1, 1) for tree in self.trees]
...
class FONN1(MLP):
    def __init__(
        ...
        super().__init__(hidden_dim, max_iter, learning_rate_init)
        self.num_trees = num_trees
...
class FONN2(MLP):
    ...
    def _backward(self, X, y, activations):
        ...
        d_bias_output = np.mean(output_error, axis=0)
        hidden_error = np.dot(output_error, self.weights_output.T)[:, : -self.num_trees] * (
...
class TREENN1(FONN1):
    def __init__(self, hidden_dim, max_iter=1000, learning_rate_init=0.01):
        super().__init__(hidden_dim, num_trees=1, max_iter=max_iter, learning_rate_init=learning_rate_init, alpha=1.0)
...
class TREENN2(FONN2):
    def __init__(self, hidden_dim, max_iter=1000, learning_rate_init=0.01):
        super().__init__(hidden_dim, num_trees=1, max_iter=max_iter, learning_rate_init=learning_rate_init)
